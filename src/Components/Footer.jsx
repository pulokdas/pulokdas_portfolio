...
const Footer = () => {
  return (
    <footer className=" mt-32 flex flex-col justify-center items-center p-4 bg-neutral bg-opacity-20 text-neutral-content">
    
    <div>
        <h1 className='text-2xl md:text-3xl'>Thanks For Visiting!</h1>
    </div>
